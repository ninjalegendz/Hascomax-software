...
export function ExpenseCategoryManagerDialog({ isOpen, onOpenChange }: ExpenseCategoryManagerDialogProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Add or edit your expense categories.</DialogDescription>
        </DialogHeader>
